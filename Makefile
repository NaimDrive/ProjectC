...
OBJS = initGame.o fight.o commands.o colors.o fightMode.o endGame.o displayGame.o main.o

game: $(OBJS)
	gcc -o game main.o initGame.o fight.o commands.o colors.o fightMode.o endGame.o displayGame.o
